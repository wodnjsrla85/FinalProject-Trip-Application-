...
import 'package:travel_web/ui/pages/edit/airplane_end_edit_page.dart';
import '../../../data/airplane_end_repository.dart';
import '../../../models/airplane_end.dart';
import '../../widgets/fare_chips_end.dart';
  ...
  Future<void> _delete() async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text('이 도착편 정보를 삭제할까요? 되돌릴 수 없습니다.'),
        actions: [
    ...
    try {
      await FirebaseFirestore.instance.collection('airplane_end').doc(widget.docId).delete();
      if (!mounted) return;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          FareChipsEnd(a: a, peak: false),
          const SizedBox(height: 12),
          const Text('성수기 평균 운임'),
          FareChipsEnd(a: a, peak: true),
        ],
      ),
    );
  }
