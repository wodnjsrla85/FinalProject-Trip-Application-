...
class _AirplaneEndEditPageState extends State<AirplaneEndEditPage> {
  ...
  final _destination = TextEditingController(text: 'ICN');
  ...
  Future<void> _save() async {
    ...
    try {
      final data = <String, dynamic>{
        ...
        "목적지": _destination.text.trim(), // ICN (고정이더라도 저장)
        "예상 소요 시간": mins,
        "직항여부": directInt,
        "직항/경유": directTxt,
        "상태": "운행",
                    ...
                    Expanded(
                      child: Autocomplete<String>(
                        ...
                        fieldViewBuilder: (context, textController, focusNode, _) {
                          // 최초 1회만 초기 동기화
                          if (textController.text.isEmpty && _origin.text.isNotEmpty) {
                          ...
                          return TextFormField(
                            ...
                            decoration: const InputDecoration(labelText: '출발지 (IATA)'),
                            onChanged: (v) {
